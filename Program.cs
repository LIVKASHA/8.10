...
namespace App
{
    ...
    /// При решении задачи
    /// создать не менее двух классов с атрибутами и методами.
    /// Для хранения данных использовать файл. Запись и чтение файла в программе
    /// производить не более одного раза за проход алгоритма.
    /// У класса создать как минимум два перегруженных и использующихся
    /// конструктора.
    /// Все атрибуты классов должны иметь уровень видимости private.
    /// Примечание
    /// Работа должна включать как минимум два вручную созданных класса: ваш
    /// объект (заявка, автобус, книга и пр.) и система управления списком этих
    /// объектов. Ни один из этих классов НЕ должен работать с классом Console.
    /// Оценка снижается на 5 баллов, если в работе используются коллекции C# (List
    /// и пр).
    /// </summary>
